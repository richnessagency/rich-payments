...
- Return safer, clearer Paymob Intention API failure messages with the selected method and masked Integration ID context.

## [0.2.1] - 2026-08-20

### Fixed

- Normalize Egyptian mobile wallet billing phone numbers to the local `01xxxxxxxxx` format before creating Paymob Intention API sessions.

## [0.1.5] - 2026-08-13

### Fixed

- Sent Paymob Intention API line items with the required `amount` field instead of the package-internal `amount_minor` key.
- Sent numeric Paymob Integration IDs as integers in the Intention API payload.

## [0.1.4] - 2026-08-13

### Changed

- Show masked previews for saved payment method Integration IDs in the admin gateway form.
- Trim Integration IDs before saving them to avoid copy/paste whitespace issues.
